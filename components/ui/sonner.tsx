  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:rounded-xl group-[.toaster]:border group-[.toaster]:bg-popover/95 group-[.toaster]:px-4 group-[.toaster]:py-3 group-[.toaster]:font-sans group-[.toaster]:text-sm group-[.toaster]:shadow-lg",
