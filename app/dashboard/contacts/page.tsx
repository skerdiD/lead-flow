  ...
  return (
    <div className="min-w-0 space-y-5">
      ...
      {data.records.length === 0 ? (
        <div className="rounded-3xl border border-dashed bg-muted/20 px-6 py-14 text-center"><h2 className="font-semibold">{hasFilters ? "No results match your search." : "No contacts yet"}</h2><p className="mt-2 text-sm text-muted-foreground">{hasFilters ? "Try another search or clear your filters." : "Add a contact to keep the people behind your opportunities connected."}</p></div>
      ) : (
